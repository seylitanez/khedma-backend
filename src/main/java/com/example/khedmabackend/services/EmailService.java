...
public class EmailService {
    ...
    public void sendMail(String to,String name,String token) throws MessagingException {
        ...
        mimeMessageHelper.setFrom("itanezseyl@gmail.com");
        mimeMessageHelper.setTo(to);
        mimeMessageHelper.setSubject("test d'envoi de mail spring boot");
        mimeMessageHelper.setText("<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
