...
@Service
public class JwtServiceGoogle {
    private static final String SECRET_KEY="34753778214125442A472D4B6150645367566B59703373357638792F423F4528";
    public String extractUsername(String token) {
        return extractClaim(token, Claims::getSubject);
    }
    public boolean extractIsGoogleUser(String token) {
        return extractClaim(token, (claims)->claims.get("isGoogleUser", Boolean.class));
    }
